...
public class MemberTest {
    ...
    public void intDateTimeExceptionTest() throws SQLException {
        Member member = new Member(DynamicType.DATETIME, "name", new byte[4]);
        member.getInt();
    }

    @Test(expected = SQLException.class)
    public void intDateExceptionTest() throws SQLException {
        Member member = new Member(DynamicType.DATE, "name", new byte[4]);
        member.getInt();
    }

    @Test(expected = SQLException.class)
    public void intDyncolExceptionTest() throws SQLException {
        Member member = new Member(DynamicType.DYNCOL, "name", new byte[4]);
        member.getInt();
    }
